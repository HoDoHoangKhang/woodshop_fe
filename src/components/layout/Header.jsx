              ...
              {isAuthenticated ? (
                <div className="relative" ref={userMenuRef}>
                  <button
                    ...
                    className="flex items-center justify-center w-8 h-8 rounded-full hover:bg-[#3e342d] transition-colors cursor-pointer"
                  >
                    <svg
                  ...
                  {isUserMenuOpen && (
                    <div className="absolute right-0 mt-2 w-48 bg-[#302924] rounded-md shadow-lg py-1 z-50">
                      ...
                      <button
                        ...
                        className="cursor-pointer flex items-center w-full px-4 py-2 text-sm text-[#9e9181] hover:bg-[#3e342d] hover:text-[#d89c4a]"
                      >
