        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
          ...
          <div className="text-gray-700">
            <div className="mb-7">
              ...
              <p className="mb-2">
                <span className="font-medium">MST:</span> 600 157 6774
              </p>
              <p className="mb-2">
            ...
            <div className="mb-7">
              ...
              <p className="mb-2">
                <span className="font-medium">MST:</span> 0318763733
              </p>
              <p className="mb-2">
                <span className="font-medium">Địa chỉ:</span> 1 Đường Thành Lộc
                31, Thành Lộc, Quận 12, Hồ Chí Minh
              </p>
            </div>
            ...
            <div className="mb-7">
              <h2 className="text-lg font-semibold mb-3 uppercase">HOTLINE:</h2>
              <p className="mb-2">Hotline</p>
              <p className="mb-2">
                <span className="font-medium">Cửa Hàng:</span> 0945 81 3878
              </p>
              <p className="mb-2">
                <span className="font-medium">Đại Lý & Gia Công:</span> 0969 400
                402
              </p>
            </div>
