...
const BlogDetail = () => {
    ...
    useEffect(() => {
        ...
        if (foundPost) {
            ...
            // Tìm các bài viết liên quan dựa trên tag
                    ...
                    <div className="p-6 md:p-8">
                        ...
                        <div className="prose max-w-none">
                            ...
                            <p className="mb-4">
                                ...
                                lacinia, nisl nisl aliquam nisl, eget aliquam
                                nisl nisl sit amet nisl. Sed euismod, nisl vel
                                ultricies lacinia, nisl nisl aliquam nisl, eget
                            ...
                            <p className="mb-4">
                                Sed euismod, nisl vel ultricies lacinia, nisl
                                nisl aliquam nisl, eget aliquam nisl nisl sit
                                amet nisl. Sed euismod, nisl vel ultricies
                                lacinia, nisl nisl aliquam nisl, eget aliquam
                            ...
                            <blockquote className="border-l-4 border-[#d89c4a] pl-4 italic my-6">
                                "Đồ chơi gỗ không chỉ mang lại niềm vui mà còn
                                giúp trẻ phát triển nhiều kỹ năng quan trọng.
                                Với thiết kế đơn giản nhưng đầy cảm hứng, chúng
                                là công cụ tuyệt vời để kích thích trí tưởng
